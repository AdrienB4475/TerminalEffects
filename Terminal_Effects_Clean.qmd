...
lact_prior <- c(
  ...
  prior(normal(0, 5), class = "b", coef = "age:ageclassinexperienced"),
  prior(normal(0, 5), class = "b", coef = "ageclassexperienced:terminal"),
  prior(normal(0, 5), class = "b", coef = "ageclassinexperienced:terminal"),
  prior(student_t(3,0, 5), class = "sd", group = "animalID"),
  prior(student_t(3,0, 5), class = "sd", group = "year_fct")
)
...
priors_wt <- c(
  ...
  prior(normal(0,4), class = "b", coef = "age"),
  prior(normal(0,4), class = "b", coef = "age_post_prime"),
  prior(normal(0,4), class = "b", coef = "age_prime"),
  prior(normal(0,4), class = "b", coef = "terminal:ageclass3inexperienced"),
  prior(normal(0,4), class = "b", coef = "terminal:ageclass3postMprime"),
  prior(normal(0,4), class = "b", coef = "terminal:ageclass3prime"),
  prior(student_t(3, 0, 20), class = "sd", group = "animalID"),
  prior(student_t(3, 0, 20), class = "sd", group = "year"),
...
priors_sex <- c(
  ...
  prior(normal(0, 2), class = "b", coef = "age10"),
  prior(normal(0, 2), class = "b", coef = "age10:ageclassexperienced"),
  prior(normal(0, 2), class = "b", coef = "ageclassexperienced:terminal"),
  prior(normal(0, 2), class = "b", coef = "ageclassinexperienced:terminal"),
