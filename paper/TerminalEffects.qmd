...
hist(lact_dat$lactation_duration)
...
#CONTINUING HERE WITH NON-INTEGER ERROR, 
#may have to round it ton clear non-integer error?
lact_dat$lac_rescale <- round(lact_dat$lac_rescale)
