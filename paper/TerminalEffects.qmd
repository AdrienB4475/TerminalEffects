...
ggplot(ofsp_pred, aes(x = x, y = predicted)) +
  ...
  # Optional: Add observed summary points for flair (totally optional)
  # geom_pointrange(data = your_summary_df, aes(x = age, y = male_prop, ...)) +
  
  # Add vertical line at maturity threshold
