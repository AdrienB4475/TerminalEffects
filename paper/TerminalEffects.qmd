...
lact_dat <- bioseal %>% 
  ...
  mutate(ageclass = ifelse(age == 8, "old", "young"))

  #So now we can...do stuff.. starting with Gamma vs negative binomial distribution 
# This is gamma
glmer(lactation_duration ~ age + terminal : ageclass + (1 | animalID) + (1 | year),
      family = Gamma(link = "inverse"),
      data = lact_dat)
#This is Negative Binomial
glmer.nb(lactation_duration ~ age + terminal : ageclass + (1 | animalID) + (1 | year),
         data = lact_dat)
